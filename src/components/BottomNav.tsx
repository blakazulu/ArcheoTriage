...
import { Home, ClipboardList, FolderOpen, BookOpen } from 'lucide-react'
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-slate-dark px-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 flex justify-around z-40 shadow-[0_-4px_12px_rgba(0,0,0,0.15)] lg:top-[70px] lg:bottom-auto lg:right-auto lg:w-20 lg:h-[calc(100vh-70px)] lg:flex-col lg:justify-start lg:gap-2 lg:px-2 lg:py-6">
      {/* Top border line */}
